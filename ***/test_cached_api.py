...
class TestCachedAPI:
    ...
    def test_connect_to_api_with_cache(self, mock_connector_class):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Мокаем FileCache
            with patch.object(api.cache, "load_response", return_value=None), patch.object(api.cache, "save_response"):
    ...
    def test_is_complete_response_valid(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            valid_data = {"items": [{"id": "1", "title": "Test"}], "found": 1}
    ...
    def test_validate_response_structure_valid(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            valid_data = {"items": [{"id": "1", "title": "Test"}]}

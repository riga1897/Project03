...
def simple_cache(ttl: Optional[int] = None, max_size: int = 1000) -> Callable:
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            actual_ttl = ttl if ttl is not None else int(os.getenv("CACHE_TTL", 3600))
        ...
        def cache_info() -> Dict[str, Any]:
            ...
            return {
                "size": len(cache),
                "max_size": max_size,
                "ttl": ttl if ttl is not None else int(os.getenv("CACHE_TTL", 3600)),
            }
...
class FileCache:
    ...
    def get_cache_files(self, source: Optional[str] = None) -> list:

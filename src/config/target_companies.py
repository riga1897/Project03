...
Компании выбраны на основе реального кэша SuperJob API.
"""
...
class TargetCompanies:
    ...
    # Список целевых компаний - обновлен с использованием реального кэша SuperJob
    COMPANIES = [
        # Компании с обоими API (5 шт.)
        CompanyInfo(
            name="СБЕР",
            hh_id="3529",
            sj_id="16134",
        ...
        # Топ компании из реального кэша SuperJob (9 шт.)
        CompanyInfo(
            name="VK: Старт карьеры",
            hh_id="15478",
            sj_id="4904563",
            description="VK для начинающих специалистов - топ по количеству вакансий (4 шт.)",
        ),
        CompanyInfo(
            name="Социальный фонд России",
            hh_id="3127",
            sj_id="4887815",
            description="Государственное учреждение - топ по количеству вакансий (4 шт.)",
        ),
        CompanyInfo(
            name="Федеральное бюджетное учреждение, ВВУЗ",
            hh_id=None,
            sj_id="2339875",
            description="Высшее военное учебное заведение (ID из реального кэша SuperJob)",
        ),
        CompanyInfo(
            name="Азот-Взрыв",
            hh_id=None,
        ...
        # Дополнительные компании из реального кэша SuperJob
        CompanyInfo(
            name="Skyeng",
            hh_id=None,
            sj_id="4922082",
        ...
        CompanyInfo(
            ...
            hh_id=None,
            sj_id="4912417",
            description="IT-решения и разработка (ID из реального кэша SuperJob)",
        ),
    ]

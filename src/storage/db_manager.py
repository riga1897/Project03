...
from src.storage.db_psycopg2_compat import get_psycopg2, get_psycopg_error
from src.storage.db_psycopg2_compat import is_available as psycopg2_available

# Убран TYPE_CHECKING блок с неиспользуемым импортом
...
class DBManager(AbstractDBManager):
    ...
    def _fill_companies_table(self, cursor: Any) -> None:
    ...
    def get_companies_and_vacancies_count(self) -> list:
        ...
        try:
            ...
            logger.error(f"Ошибка при получении статистики по компаниям: {e}")
            return []
            ...
            with self._get_connection() as conn:
                with conn.cursor() as cursor:
                    ...
                    return {
                        ...
                        "vacancy_salary_percentage": (
                            round((vacancies_with_salary / vacancies_count * 100), 1) if vacancies_count > 0 else 0
                        ),

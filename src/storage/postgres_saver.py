...
class PostgresSaver(AbstractVacancyStorage):
    ...
    def __init__(self, db_config: Optional[Dict[str, str]] = None):
        ...
        # УДАЛЕНО: self._ensure_tables_exist() - создание таблиц теперь только в DBManager.create_tables()
    ...
    # УДАЛЕНО: _ensure_companies_table_exists() - функциональность перенесена в DBManager.create_tables()
    ...
    # УДАЛЕНО: _ensure_tables_exist() - функциональность перенесена в DBManager.create_tables()

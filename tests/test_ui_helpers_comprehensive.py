...
class TestUIHelpersConfirmation:
...
class TestUIHelpersVacancyFiltering:
    ...
    def test_filter_vacancies_by_keyword_single(self):
        ...
        vacancies = [
            create_test_vacancy("Python Developer", "Python programming"),
            create_test_vacancy("Java Developer", "Java programming"),
            create_test_vacancy("Full-stack Developer", "Python and Java")
        ]
    ...
    def test_filter_vacancies_by_keyword_and_operator(self):
        ...
        vacancies = [
            create_test_vacancy("Python Developer", "Python and Django"),
            create_test_vacancy("Java Developer", "Java programming"),
            create_test_vacancy("Python Junior", "Python only")
        ]
    ...
    def test_filter_vacancies_by_keyword_or_operator(self):
        ...
        vacancies = [
            create_test_vacancy("Python Developer", "Python programming"),
            create_test_vacancy("Java Developer", "Java programming"),
            create_test_vacancy("C++ Developer", "C++ programming")
        ]
...
class TestUIHelpersSearchParsing:
...
class TestUIHelpersBuildSearchableText:
...
class TestUIHelpersDebug:
    ...
    def test_debug_search_vacancies(self, mock_print):
        ...
        vacancies = [create_test_vacancy() for _ in range(3)]
...
class TestUIHelpersIntegration:
    ...
    def test_full_search_workflow(self):
        ...
        vacancies = [
            create_test_vacancy("Python Developer", "Python and Django development"),
            create_test_vacancy("Java Developer", "Java enterprise development"),
            create_test_vacancy("Full-stack Developer", "Python and JavaScript development")
        ]
        
        # Тестируем различные поисковые запросы
        python_results = filter_vacancies_by_keyword(vacancies, "Python")
        assert isinstance(python_results, list)
        
        # Тестируем логические операторы
        and_results = filter_vacancies_by_keyword(vacancies, "Python AND Django")
        assert isinstance(and_results, list)
        
        or_results = filter_vacancies_by_keyword(vacancies, "Python OR Java")
...
class TestUIHelpersEdgeCases:
    ...
    def test_search_with_special_characters(self):
        ...
        result = filter_vacancies_by_keyword(vacancies, "C++")
        assert isinstance(result, list)
    ...
    def test_search_with_unicode(self):
        ...
        vacancies = [
            create_test_vacancy("Разработчик Python", "Программирование на Python")
        ]

...
class TestEnvLoaderGetEnvVar:
    ...
    def test_get_env_var_none_default(self) -> None:
        """Покрытие получения переменной с None как default"""
        with patch.dict('os.environ', {}, clear=True):
            result = EnvLoader.get_env_var("KEY", None)
            assert result is None

    def test_get_env_var_empty_string_default(self) -> None:
...
class TestEnvLoaderGetEnvVarInt:
    ...
    def test_get_env_var_int_valid_integer(self) -> None:
    ...
    def test_get_env_var_int_negative_integer(self) -> None:
    ...
    def test_get_env_var_int_default_zero(self) -> None:
        """Покрытие использования default=0"""
        with patch.dict('os.environ', {}, clear=True):
            result = EnvLoader.get_env_var_int("KEY")  # default=0 по умолчанию
            assert result == 0

    def test_get_env_var_int_large_number(self) -> None:
    ...
    def test_get_env_var_int_whitespace(self) -> None:
...
class TestEnvLoaderIntegration:
    ...
    def test_class_state_consistency(self) -> None:
    ...
    def test_static_methods_independence(self) -> None:

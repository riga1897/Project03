...
class TestBaseFormatterAbstractClass:
    ...
    def test_abstract_methods_definitions(self) -> None:
...
class TestBaseFormatterMethodSignatures:
    ...
    def test_format_vacancy_info_signature(self) -> None:
...
class TestBaseFormatterConcreteImplementation:
    ...
    def test_concrete_implementation_instantiation(self) -> None:
    ...
    def test_format_vacancy_info_implementation(self) -> None:
    ...
    def test_format_salary_implementation(self) -> None:
    ...
    def test_format_currency_implementation(self) -> None:
    ...
    def test_format_text_implementation(self) -> None:
    ...
    def test_format_date_implementation(self) -> None:
    ...
    def test_format_experience_implementation(self) -> None:
    ...
    def test_format_employment_type_implementation(self) -> None:
    ...
    def test_format_schedule_implementation(self) -> None:
    ...
    def test_format_company_name_implementation(self) -> None:
    ...
    def test_clean_html_tags_implementation(self) -> None:
    ...
    def test_format_number_implementation(self) -> None:
...
class TestBaseFormatterAbstractMethodsCoverage:
    ...
    def test_abstract_method_direct_calls(self) -> None:
...
class TestBaseFormatterIntegration:
    ...
    def test_full_formatter_workflow(self) -> None:

...
from src.vacancies.parsers import BaseParser
...
class TestBaseParser:
    ...
    def test_base_parser_init(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.base_parser.BaseParser')
    def test_base_parser_abstract_methods(self, mock_parser_class):
...
class TestHHParser:
    ...
    def test_hh_parser_init(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.hh_parser.HHParser')
    def test_hh_parse_vacancy_basic(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.hh_parser.HHParser')
    def test_hh_parse_vacancy_no_salary(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.hh_parser.HHParser')
    def test_hh_get_vacancies_url(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.hh_parser.HHParser')
    def test_hh_parse_error_handling(self, mock_parser_class):
...
class TestSuperJobParser:
    ...
    def test_sj_parser_init(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.sj_parser.SuperJobParser')
    def test_sj_parse_vacancy_basic(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.sj_parser.SuperJobParser')
    def test_sj_parse_vacancy_no_salary(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.sj_parser.SuperJobParser')
    def test_sj_get_vacancies_url(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.sj_parser.SuperJobParser')
    def test_sj_api_key_handling(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.sj_parser.SuperJobParser')
    def test_sj_parse_error_handling(self, mock_parser_class):
...
class TestParsersIntegration:
    ...
    @patch('src.vacancies.parsers.hh_parser.HHParser')
    @patch('src.vacancies.parsers.sj_parser.SuperJobParser')
    def test_parsers_comparison(self, mock_sj_class, mock_hh_class):
    ...
    @patch('src.vacancies.parsers.base_parser.BaseParser')
    def test_parser_inheritance(self, mock_base_class):
...
class TestParsersErrorScenarios:
    ...
    @patch('src.vacancies.parsers.hh_parser.HHParser')
    def test_hh_missing_fields(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.sj_parser.SuperJobParser')
    def test_sj_missing_fields(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.hh_parser.HHParser')
    def test_hh_malformed_data(self, mock_parser_class):
    ...
    @patch('src.vacancies.parsers.sj_parser.SuperJobParser')
    def test_sj_malformed_data(self, mock_parser_class):

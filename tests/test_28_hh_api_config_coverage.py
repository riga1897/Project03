...
class TestHHAPIConfig:
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_init_with_custom_values(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_post_init_env_false(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_post_init_env_true(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_post_init_env_one(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_post_init_env_yes(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_post_init_env_on(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_post_init_env_uppercase_true(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_post_init_env_random_string(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_post_init_env_none(self, mock_get_env_var):
...
class TestHHAPIConfigGetParams:
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_get_params_partial_override(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_get_params_custom_params_with_kwargs(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_get_params_empty_custom_params(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_get_params_none_custom_params_default_factory(self, mock_get_env_var):
...
class TestHHAPIConfigGetHHParams:
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_get_hh_params_compatibility(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_get_hh_params_without_args(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_get_hh_params_with_kwargs(self, mock_get_env_var):
...
class TestHHAPIConfigIntegration:
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_dataclass_field_defaults(self, mock_get_env_var):
    ...
    @patch('src.config.hh_api_config.EnvLoader.get_env_var')
    def test_method_consistency(self, mock_get_env_var):

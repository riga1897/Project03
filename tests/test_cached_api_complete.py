...
class TestCachedAPIComplete:
    ...
    @patch.object(ConcreteCachedAPI, '_load_from_cache', return_value=None, create=True)
    @patch.object(ConcreteCachedAPI, '_save_to_cache', return_value=True, create=True)

...
class TestDatabaseConfig:
    ...
    def test_init_calls_get_default_config(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_default_config_without_database_url(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_default_config_with_defaults(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_default_config_with_database_url(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_config_without_custom_config(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_config_with_custom_config(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_config_custom_config_copy(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_connection_params_basic(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_connection_params_with_ssl(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_get_connection_params_without_ssl(self, mock_get_env_var):
...
class TestDatabaseConfigParseURL:
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_postgresql_scheme(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_postgres_scheme(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_unsupported_scheme(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_no_auth(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_username_only(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_no_port(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_no_database(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_with_ssl_params(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_with_params_no_ssl(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_minimal(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_complex_password(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_parse_database_url_exception_handling(self, mock_get_env_var):
...
class TestDatabaseConfigTestConnection:
    ...
    def test_test_connection_success_default_config(self, mock_connect, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    @patch('psycopg2.connect')
    def test_test_connection_success_custom_config(self, mock_connect, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    @patch('psycopg2.connect')
    def test_test_connection_failure(self, mock_connect, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_test_connection_import_error(self, mock_get_env_var):
...
class TestDatabaseConfigIntegration:
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_full_workflow_with_database_url(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_full_workflow_with_env_vars(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_error_resilience(self, mock_get_env_var):
    ...
    @patch('src.config.db_config.EnvLoader.get_env_var')
    def test_configuration_consistency(self, mock_get_env_var):

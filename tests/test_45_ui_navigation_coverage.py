...
def custom_action_success():
    """Успешное пользовательское действие"""
    return "success"


def custom_action_with_exception():
...
class TestUINavigationInit:
    ...
    def test_global_instance_exists(self):
        ...
        from src.utils.ui_navigation import ui_navigation
...
class TestPaginateDisplay:
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_paginate_display_multiple_pages_quit(self, mock_print, mock_input):
...
class TestDisplayPage:
    ...
    @patch('builtins.print')
    def test_display_page_first_page(self, mock_print):
    ...
    @patch('builtins.print')
    def test_display_page_last_page(self, mock_print):
...
class TestDisplayNavigationMenu:
    ...
    @patch('builtins.print')
    def test_display_navigation_menu_single_page(self, mock_print):
...
class TestHandleNavigationChoice:
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_handle_navigation_choice_invalid_page_number(self, mock_print, mock_input):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_handle_navigation_choice_zero_page(self, mock_print, mock_input):
    ...
    def test_handle_navigation_choice_custom_action_success(self):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_handle_navigation_choice_custom_action_exception(self, mock_print, mock_input, mock_logger):
    ...
    def test_handle_navigation_choice_unknown_custom_action(self):
    ...
    def test_handle_navigation_choice_non_digit(self):
...
class TestGetPageData:
    ...
    def test_get_page_data_page_too_low(self):
    ...
    def test_get_page_data_page_too_high(self):
    ...
    def test_get_page_data_exact_fit(self):
...
class TestQuickPaginateFunction:
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_quick_paginate_multiple_pages(self, mock_print, mock_input):
...
class TestIntegrationScenarios:
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_full_navigation_flow(self, mock_print, mock_input):
    ...
    @patch('builtins.input')  
    @patch('builtins.print')
    def test_error_recovery_flow(self, mock_print, mock_input):
    ...
    @patch('builtins.input')
    @patch('builtins.print')
    def test_custom_formatter_integration(self, mock_print, mock_input):
        """Покрытие: интеграция с кастомным форматтером"""
        def complex_formatter(item, number=None):
            if number:

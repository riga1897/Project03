...
class TestDBManagerDemoCompaniesAndVacanciesCount:
    ...
    def test_demo_companies_and_vacancies_count_no_data(self):
...
class TestDBManagerDemoAllVacancies:
    ...
    def test_demo_all_vacancies_with_data(self):
    ...
    def test_demo_all_vacancies_sorting_logic(self):
...
class TestDBManagerDemoAvgSalary:
    ...
    def test_demo_avg_salary_success(self):
    ...
    def test_demo_avg_salary_none(self):
...
class TestDBManagerDemoHigherSalary:
    ...
    def test_demo_vacancies_with_higher_salary_success(self):
    ...
    def test_demo_vacancies_with_higher_salary_empty(self):
...
class TestDBManagerDemoKeywordSearch:
    ...
    def test_demo_vacancies_with_keyword_success(self):
    ...
    def test_demo_vacancies_with_keyword_empty(self):
...
class TestDBManagerDemoDatabaseStats:
    ...
    def test_demo_database_stats_full_data(self):
    ...
    def test_demo_database_stats_minimal_data(self):
    ...
    def test_demo_database_stats_string_dates(self):
    ...
    def test_demo_database_stats_no_data(self):
...
class TestDBManagerDemoFullDemo:
    ...
    def test_run_full_demo_success(self):
    ...
    def test_run_full_demo_connection_failure(self):
...
class TestDBManagerDemoEdgeCases:
    ...
    def test_get_salary_value_function_edge_cases(self):
    ...
    def test_large_vacancy_list_truncation(self):

...
class TestUserInterface:
    ...
    def user_interface(self, mock_storage, mock_db_manager):
        ...
        with patch("src.ui_interfaces.console_interface.UnifiedAPI") as mock_unified_api, patch(
            "src.ui_interfaces.console_interface.VacancySearchHandler"
        ) as mock_search_handler, patch(
            "src.ui_interfaces.console_interface.VacancyDisplayHandler"
        ) as mock_display_handler, patch(
    ...
    def test_initialization_default_storage(self, mock_db_manager):
        ...
        with patch("src.ui_interfaces.console_interface.StorageFactory.get_default_storage") as mock_factory, patch(
            "src.ui_interfaces.console_interface.UnifiedAPI"
        ), patch("src.ui_interfaces.console_interface.VacancySearchHandler"), patch(
            "src.ui_interfaces.console_interface.VacancyDisplayHandler"
        ), patch(
            "src.ui_interfaces.vacancy_operations_coordinator.VacancyOperationsCoordinator"
        ):
    ...
    def test_initialization_with_mocks(
        self, mock_coordinator, mock_display, mock_search, mock_api, mock_storage, mock_db_manager
    ):

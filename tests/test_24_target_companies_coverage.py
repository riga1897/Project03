...
class TestCompanyInfo:
    ...
    def test_company_info_all_fields(self) -> None:
    ...
    def test_company_info_minimal_fields(self) -> None:
    ...
    def test_company_info_optional_sj_id(self) -> None:
    ...
    def test_company_info_empty_description(self) -> None:
    ...
    def test_company_info_dataclass_behavior(self) -> None:
...
class TestTargetCompanies:
    ...
    def test_companies_list_exists(self) -> None:
    ...
    def test_companies_count_expected(self) -> None:
    ...
    def test_companies_required_fields(self) -> None:
    ...
    def test_get_all_companies_returns_copy(self) -> None:
    ...
    def test_get_hh_ids_all_present(self) -> None:
    ...
    def test_get_hh_ids_specific_values(self) -> None:
    ...
    def test_get_sj_ids_filtering(self) -> None:
    ...
    def test_get_sj_ids_specific_values(self) -> None:
    ...
    def test_get_company_names_all_present(self) -> None:
    ...
    def test_get_company_names_specific_values(self) -> None:
    ...
    def test_get_all_ids_union(self) -> None:
    ...
    def test_get_all_ids_no_duplicates(self) -> None:
    ...
    def test_get_company_by_hh_id_specific_companies(self) -> None:
    ...
    def test_get_company_by_sj_id_specific_companies(self) -> None:
    ...
    def test_is_target_company_hh_id(self) -> None:
    ...
    def test_is_target_company_sj_id(self) -> None:
    ...
    def test_find_company_by_exact_name_found(self) -> None:
    ...
    def test_find_company_by_exact_name_case_insensitive(self) -> None:
    ...
    def test_find_company_by_exact_name_all_companies(self) -> None:
...
class TestTargetCompaniesLegacyConstants:
    ...
    def test_target_companies_constant_exists(self) -> None:
    ...
    def test_target_companies_constant_structure(self) -> None:
    ...
    def test_target_companies_constant_values(self) -> None:
...
class TestLegacyFunctions:
    ...
    def test_get_target_company_ids_function(self) -> None:
    ...
    def test_get_target_company_names_function(self) -> None:
    ...
    def test_legacy_functions_specific_values(self) -> None:
...
class TestTargetCompaniesEdgeCases:
    ...
    def test_companies_with_missing_sj_id(self) -> None:
    ...
    def test_empty_string_searches(self) -> None:
    ...
    def test_unique_company_ids(self) -> None:
    ...
    def test_company_names_uniqueness(self) -> None:
...
class TestTargetCompaniesIntegration:
    ...
    def test_full_company_lookup_workflow(self) -> None:
    ...
    def test_cross_method_consistency(self) -> None:

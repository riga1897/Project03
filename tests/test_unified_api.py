...
class TestUnifiedAPI:
    ...
    def test_get_available_sources(self):
        ...
        with patch('src.vacancies.parsers.sj_parser.SuperJobParser'), \
             patch('src.api_modules.sj_api.SuperJobAPI'), \
             patch('src.api_modules.hh_api.HeadHunterAPI'):
    ...
    @patch('src.api_modules.sj_api.SuperJobAPI')
    @patch('src.api_modules.hh_api.HeadHunterAPI')
    @patch('src.vacancies.vacancy.Vacancy')
    @patch('src.database.postgres_saver.PostgresSaver')
    def test_filter_by_target_companies_with_data(self, mock_postgres, mock_vacancy, mock_hh_api, mock_sj_api, mock_parser):

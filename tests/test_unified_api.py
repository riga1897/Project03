...
class TestUnifiedAPI:
    ...
    def test_validate_sources_empty(self, unified_api):
        """Тест валидации пустого списка источников"""
        empty_sources = []
        result = unified_api.validate_sources(empty_sources)
        
        assert result == []
    
    def test_validate_sources_none(self, unified_api):
        """Тест валидации None источников"""
        result = unified_api.validate_sources(None)

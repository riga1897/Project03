...
class TestSourceManagerInit:
    ...
    def test_init_sources_config(self) -> None:
...
class TestGetSourceConfig:
    ...
    def test_get_source_config_existing_hh(self) -> None:
    ...
    def test_get_source_config_existing_sj(self) -> None:
    ...
    def test_get_source_config_nonexistent(self) -> None:
...
class TestGetSourceDisplayName:
    ...
    def test_get_source_display_name_existing(self) -> None:
    ...
    def test_get_source_display_name_nonexistent(self) -> None:
    ...
    def test_get_source_display_name_config_without_display_name(self) -> None:
...
class TestGetSourceApiLimits:
    ...
    def test_get_source_api_limits_hh(self) -> None:
    ...
    def test_get_source_api_limits_sj(self) -> None:
    ...
    def test_get_source_api_limits_nonexistent(self) -> None:
    ...
    def test_get_source_api_limits_config_without_limits(self) -> None:
...
class TestValidateSourceCredentials:
    ...
    def test_validate_source_credentials_hh(self) -> None:
    ...
    def test_validate_source_credentials_unknown_source(self) -> None:
...
class TestGetSourcePriority:
    ...
    def test_get_source_priority_hh(self) -> None:
    ...
    def test_get_source_priority_sj(self) -> None:
    ...
    def test_get_source_priority_nonexistent(self) -> None:
    ...
    def test_get_source_priority_config_without_priority(self) -> None:
...
class TestSortSourcesByPriority:
    ...
    def test_sort_sources_by_priority_normal_order(self) -> None:
    ...
    def test_sort_sources_by_priority_already_sorted(self) -> None:
    ...
    def test_sort_sources_by_priority_with_unknown(self) -> None:
    ...
    def test_sort_sources_by_priority_empty_list(self) -> None:
...
class TestGetSourceFeatures:
    ...
    def test_get_source_features_hh(self) -> None:
    ...
    def test_get_source_features_sj(self) -> None:
    ...
    def test_get_source_features_nonexistent(self) -> None:
    ...
    def test_get_source_features_config_without_features(self) -> None:
...
class TestGetSourceConfigClass:
    ...
    def test_get_source_config_class_hh(self) -> None:
    ...
    def test_get_source_config_class_sj(self) -> None:
    ...
    def test_get_source_config_class_nonexistent(self) -> None:
    ...
    def test_get_source_config_class_config_without_class(self) -> None:
...
class TestCreateSourceInstance:
    ...
    def test_create_source_instance_hh(self) -> None:
    ...
    def test_create_source_instance_sj(self) -> None:
    ...
    def test_create_source_instance_nonexistent(self) -> None:
    ...
    def test_create_source_instance_config_without_class(self) -> None:
...
class TestDataSourceClass:
    ...
    def test_data_source_init(self) -> None:
    ...
    def test_data_source_init_different_values(self) -> None:
    ...
    def test_data_source_attributes_accessible(self) -> None:
...
class TestIntegrationScenarios:
    ...
    def test_full_source_management_flow(self) -> None:
    ...
    def test_source_features_and_config_integration(self) -> None:
    ...
    def test_data_source_with_source_manager_integration(self) -> None:

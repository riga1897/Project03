...
class TestSourceSelector:
    ...
    def test_source_selector_methods_exist(self, source_selector):
        ...
        expected_methods = [
            'get_user_source_choice', 'select_source', 'get_sources',
            'display_sources_info', 'show_sources', 'get_available_sources'
        ]
        
        existing_methods = [method for method in expected_methods 
                          if hasattr(source_selector, method)]
    ...
    def test_source_selector_integration(self, source_selector):
        ...
        methods = [attr for attr in dir(source_selector) 

...
class TestNormalizeAreaData:
    ...
    def test_normalize_area_data_with_empty_dict(self):
        """Покрытие: пустой словарь -> None"""
        result = normalize_area_data({})
        assert result is None

    def test_normalize_area_data_with_empty_name_fallback_title(self):
        """Покрытие: пустой name, переход к title"""
        area_dict = {"name": "", "title": "Ростов-на-Дону"}
        result = normalize_area_data(area_dict)
        assert result == "Ростов-на-Дону"

    def test_normalize_area_data_with_empty_title_fallback_id(self):
        """Покрытие: пустые name и title, переход к id"""
        area_dict = {"name": "", "title": "", "id": 789}
        result = normalize_area_data(area_dict)
        assert result == "789"

    def test_normalize_area_data_with_integer_input(self):
        """Покрытие: числовой input -> str()"""
        result = normalize_area_data(12345)  # type: ignore
        assert result == "12345"

    def test_normalize_area_data_with_list_input(self):
        """Покрытие: список -> str()"""
        result = normalize_area_data([1, 2, 3])  # type: ignore
        assert result == "[1, 2, 3]"

    def test_normalize_area_data_with_boolean_input(self):
        """Покрытие: bool -> str()"""
        result = normalize_area_data(True)  # type: ignore
        assert result == "True"

    def test_normalize_area_data_with_float_input(self):
        """Покрытие: float -> str()"""
...
class TestNormalizeExperienceData:
    ...
    def test_normalize_experience_data_with_empty_dict(self):
        """Покрытие: пустой словарь"""
        result = normalize_experience_data({})
        assert result is None

    def test_normalize_experience_data_with_integer_input(self):
        """Покрытие: числовой input"""
        result = normalize_experience_data(5)  # type: ignore
        assert result == "5"

    def test_normalize_experience_data_with_whitespace_string(self):
        """Покрытие: строка из пробелов"""
        result = normalize_experience_data("   ")
        assert result is None

    def test_normalize_experience_data_with_padded_string(self):
        """Покрытие: строка с пробелами по краям"""
...
class TestNormalizeEmploymentData:
    ...
    def test_normalize_employment_data_with_none(self):
        """Покрытие: None input"""
        result = normalize_employment_data(None)
        assert result is None

    def test_normalize_employment_data_with_empty_string(self):
        """Покрытие: пустая строка"""
        result = normalize_employment_data("")
        assert result is None

    def test_normalize_employment_data_with_valid_string(self):
        """Покрытие: валидная строка"""
        result = normalize_employment_data("Полная занятость")
        assert result == "Полная занятость"

    def test_normalize_employment_data_with_dict_name_key(self):
        """Покрытие: словарь с ключом 'name'"""
        emp_dict = {"name": "Частичная занятость"}
        result = normalize_employment_data(emp_dict)
        assert result == "Частичная занятость"

    def test_normalize_employment_data_with_dict_title_key(self):
        """Покрытие: словарь с ключом 'title'"""
        emp_dict = {"title": "Проектная работа"}
        result = normalize_employment_data(emp_dict)
        assert result == "Проектная работа"

    def test_normalize_employment_data_with_dict_type_key(self):
        """Покрытие: словарь с ключом 'type'"""
        emp_dict = {"type": "full"}
        result = normalize_employment_data(emp_dict)
        assert result == "full"

    def test_normalize_employment_data_with_dict_id_key(self):
        """Покрытие: словарь с ключом 'id'"""
        emp_dict = {"id": "part_time"}
        result = normalize_employment_data(emp_dict)
        assert result == "part_time"

    def test_normalize_employment_data_with_dict_priority(self):
    ...
    def test_normalize_employment_data_with_empty_dict(self):
        """Покрытие: пустой словарь"""
        result = normalize_employment_data({})
        assert result is None

    def test_normalize_employment_data_with_whitespace_string(self):
        """Покрытие: строка из пробелов"""
        result = normalize_employment_data("   ")
        assert result is None

    def test_normalize_employment_data_with_padded_string(self):
        """Покрытие: строка с пробелами по краям"""
        result = normalize_employment_data("  Стажировка  ")
        assert result == "Стажировка"

    def test_normalize_employment_data_with_integer_input(self):
        """Покрытие: числовой input"""
...
class TestNormalizeEmployerData:
    ...
    def test_normalize_employer_data_with_none(self):
        """Покрытие: None input"""
        result = normalize_employer_data(None)
        assert result is None

    def test_normalize_employer_data_with_empty_string(self):
        """Покрытие: пустая строка"""
        result = normalize_employer_data("")
        assert result is None

    def test_normalize_employer_data_with_valid_string(self):
        """Покрытие: валидная строка"""
        result = normalize_employer_data("Яндекс")
        assert result == "Яндекс"

    def test_normalize_employer_data_with_dict_name_key(self):
        """Покрытие: словарь с ключом 'name'"""
        emp_dict = {"name": "Mail.ru Group"}
        result = normalize_employer_data(emp_dict)
        assert result == "Mail.ru Group"

    def test_normalize_employer_data_with_dict_title_key(self):
        """Покрытие: словарь с ключом 'title'"""
        emp_dict = {"title": "OZON"}
        result = normalize_employer_data(emp_dict)
        assert result == "OZON"

    def test_normalize_employer_data_with_dict_firm_name_key(self):
        """Покрытие: словарь с ключом 'firm_name' (SuperJob)"""
        emp_dict = {"firm_name": "СберТех"}
        result = normalize_employer_data(emp_dict)
        assert result == "СберТех"

    def test_normalize_employer_data_with_dict_id_key(self):
        """Покрытие: словарь с ключом 'id'"""
        emp_dict = {"id": "company_123"}
        result = normalize_employer_data(emp_dict)
        assert result == "company_123"

    def test_normalize_employer_data_with_dict_priority(self):
    ...
    def test_normalize_employer_data_with_dict_title_over_firm_name(self):
    ...
    def test_normalize_employer_data_with_dict_firm_name_over_id(self):
        """Покрытие: приоритет firm_name над id"""
        emp_dict = {"firm_name": "ВТБ", "id": "vtb"}
        result = normalize_employer_data(emp_dict)
        assert result == "ВТБ"  # firm_name имеет приоритет

    def test_normalize_employer_data_with_dict_other_keys(self):
        """Покрытие: словарь с другими ключами"""
    ...
    def test_normalize_employer_data_with_empty_dict(self):
        """Покрытие: пустой словарь"""
        result = normalize_employer_data({})
        assert result is None

    def test_normalize_employer_data_with_whitespace_string(self):
        """Покрытие: строка из пробелов"""
        result = normalize_employer_data("   ")
        assert result is None

    def test_normalize_employer_data_with_padded_string(self):
        """Покрытие: строка с пробелами по краям"""
        result = normalize_employer_data("  JetBrains  ")
        assert result == "JetBrains"

    def test_normalize_employer_data_with_integer_input(self):
        """Покрытие: числовой input"""
        result = normalize_employer_data(999)  # type: ignore
        assert result == "999"

    def test_normalize_employer_data_with_empty_name_fallback_title(self):
        """Покрытие: пустой name, переход к title"""
        emp_dict = {"name": "", "title": "Альфа-Банк"}
        result = normalize_employer_data(emp_dict)
        assert result == "Альфа-Банк"

    def test_normalize_employer_data_with_empty_title_fallback_firm_name(self):
        """Покрытие: пустые name и title, переход к firm_name"""
        emp_dict = {"name": "", "title": "", "firm_name": "Сбербанк"}
        result = normalize_employer_data(emp_dict)
        assert result == "Сбербанк"

    def test_normalize_employer_data_with_empty_firm_name_fallback_id(self):
...
class TestDataNormalizersEdgeCases:
    ...
    def test_all_functions_with_complex_nested_dict(self):
    ...
    def test_all_functions_with_zero_value(self):
    ...
    def test_all_functions_with_false_boolean(self):
    ...
    def test_all_functions_with_empty_list(self):
    ...
    def test_dict_with_none_values_in_priority_keys(self):
...
class TestIntegrationScenarios:
    ...
    def test_hh_ru_area_format(self):
    ...
    def test_superjob_employer_format(self):
    ...
    def test_mixed_api_experience_formats(self):
    ...
    def test_employment_type_variations(self):

...
class TestVacancyOperations:
    ...
    def test_get_vacancies_with_salary_object_format(self):
    ...
    def test_get_vacancies_with_salary_no_salary(self):
    ...
    def test_sort_vacancies_get_sort_key_dict_format(self):
    ...
    def test_sort_vacancies_get_sort_key_object_format(self):
    ...
    def test_sort_vacancies_no_salary(self):
    ...
    def test_filter_vacancies_by_salary_no_salary_cases(self):
    ...
    def test_search_vacancies_advanced_and_parsing(self):
    ...
    def test_search_vacancies_advanced_or_parsing(self):
    ...
    def test_debug_vacancy_keywords_regex_matching(self):
    ...
    def test_debug_functions_empty_fields(self):
...
class TestVacancyOperationsIntegration:
    ...
    def test_full_salary_filtering_workflow(self):

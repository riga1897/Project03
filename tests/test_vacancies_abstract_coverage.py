...
class TestAbstractVacancy:
    ...
    def test_abstract_init_method_signature(self) -> None:
    ...
    def test_abstract_to_dict_method_signature(self) -> None:
    ...
    def test_abstract_from_dict_method_signature(self) -> None:
    ...
    def test_from_dict_is_classmethod(self) -> None:
...
class TestConcreteImplementation:
    ...
    def test_concrete_implementation_with_empty_data(self) -> None:
...
class TestAbstractMethodsEnforcement:
    ...
    def test_missing_init_method_fails(self) -> None:
    ...
    def test_missing_to_dict_method_fails(self) -> None:
    ...
    def test_missing_from_dict_method_fails(self) -> None:

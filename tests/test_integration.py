...
class TestIntegrationWorkflow:
    ...
    def test_complete_vacancy_workflow_json(self, temp_json_file):
        ...
        vacancies = [
            Vacancy(
                ...
                description="Senior position for Python developer",
            ...
            Vacancy(
                ...
                description="Junior position for Java developer",
            ...
            Vacancy(
                ...
                description="DevOps position with Docker and K8s",
        ...
        assert storage.delete_vacancy_by_id("222") is True
    ...
    def test_error_handling_integration(self, temp_json_file):
        ...
        invalid_vacancy = Vacancy(title="", vacancy_id="")
    ...
    def test_api_to_storage_integration(self, mock_api, temp_json_file):
        ...
        storage = JSONSaver(temp_json_file)
        messages = storage.add_vacancy(parsed_vacancies)

...
class TestFileCacheHashGeneration:
    ...
    def test_generate_params_hash_simple(self):
    ...
    def test_generate_params_hash_complex(self):
    ...
    def test_generate_params_hash_sorted_keys(self):
    ...
    def test_generate_params_hash_empty_params(self):
...
class TestFileCacheValidResponse:
    ...
    def test_is_valid_response_invalid_data_type(self):
    ...
    def test_is_valid_response_empty_page_beyond_limit(self):
    ...
    def test_is_valid_response_no_results_non_first_page(self):
    ...
    def test_is_valid_response_first_page_no_results(self):
    ...
    def test_is_valid_response_valid_empty_page_within_limit(self):
...
class TestFileCacheValidateStructure:
    ...
    def test_validate_cached_structure_invalid_type(self):
    ...
    def test_validate_cached_structure_invalid_data_type(self):
    ...
    def test_validate_cached_structure_data_without_items(self):
    ...
    def test_validate_cached_structure_exception_handling(self):
...
class TestFileCacheLoadResponse:
    ...
    def test_load_response_file_not_exists(self):
...
class TestFileCacheDeduplication:
    ...
    def test_deduplicate_vacancies_no_items(self):
    ...
    def test_deduplicate_vacancies_empty_items(self):
